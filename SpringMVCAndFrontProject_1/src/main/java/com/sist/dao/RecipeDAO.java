...
import com.sist.vo.*;
/*
 *      스프링 => 클래스 관리 (생성 ~ 소멸 / 공통기반 => 핵심만 코딩)
 *              ---------
 *              대상 : 기능이 있는 클래스
 *              제외 : ~VO (데이터형), Interface
 *       => 일반 클래스 : @Component
...
public class RecipeDAO {
	@Autowired
	// @Qualifier(name="") => 원하는 객체 찾아오기
	private RecipeMapper mapper; // 구현된 클래스의 주소값을 가지고 온다
	/*
