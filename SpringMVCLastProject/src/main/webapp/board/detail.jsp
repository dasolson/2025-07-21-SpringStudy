				...
				<tbody>
					...
					<tr>
						<td colspan="4" class="text-right">
							<a :href="'../board/update.do?no='+vo.no" class="btn btn-sm btn-success">수정</a>
							<a class="btn btn-sm btn-info a-link" @click="del()">{{msg}}</a>
							<a href="../board/list.do" class="btn btn-sm btn-warning">목록</a>
						</td>
					</tr>
					<tr v-show="isShow">
						<td colspan="4" class="text-right">
