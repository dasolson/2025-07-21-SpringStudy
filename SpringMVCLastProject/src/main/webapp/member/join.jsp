...
<body>
	<div class="container" id="join_app">
		<div class="row">
			<h3>회원가입</h3>
			<table class="table">
				<tbody>
					<tr>
						...
						<td width="80%">
							<input type="text" ref="userid" size="20" class="imput-sm" v-model="userid">
						</td>
					</tr>
					<tr>
						<th width="20%" class="text-center">Password</th>
						<td width="80%">
							<input type="password" ref="userpwd" size="20" class="imput-sm" v-model="userpwd">
						</td>
					</tr>
					<tr>
						<th width="20%" class="text-center">이름</th>
						<td width="80%">
							<input type="text" ref="username" size="20" class="imput-sm" v-model="username">
						</td>
					</tr>
					<tr>
						<th width="20%" class="text-center">성별</th>
						<td width="80%">
							<input type="radio" value="남자" checked v-model="sex">남자
