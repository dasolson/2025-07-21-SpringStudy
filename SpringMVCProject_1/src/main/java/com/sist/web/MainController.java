 ...
 *      2. HandlerMapping    : DispatcherServlet으로부터 요청 URL / 데이터를 받아서 해당 Model을 찾아서 전송
 *                                                                              ------ 요청 구현
 ...
 *                 }  
 *                 
 *                 public String main_main(int page, HttpSession session) { => 순서 상관 없다
 *                 	   String page = request.getParameter("page");	
 *                 }
 *                 
 *                 => 매개변수
 *                     = 일반 데이터   : 페이지 / 검색어 / 번호 ...
 *                     = Command 객체 : VO 단위로 값을 받는다
